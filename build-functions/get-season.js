...
var Headers = __webpack_require__(51);
var Request = __webpack_require__(167);
var FetchError = __webpack_require__(91);
...
var bomHandling = __webpack_require__(146),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(147); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(161)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(162)(iconv);
}
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(50).concat(__webpack_require__(89)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(90).concat(__webpack_require__(160)) },
...
var convert = __webpack_require__(144).convert;
var bodyStream = __webpack_require__(165);
...
var _nodeFetch = __webpack_require__(143);
...
exports.handler = (event, context, callback) => {
  ...
  (0, _nodeFetch2.default)(`${apiRoot}tv/${event.queryStringParameters.id}/season/${event.queryStringParameters.seasonNumber}?api_key=${apiKey}`).then(res => res.json()).then(json => {

...
var FetchError = __webpack_require__(94);
...
var bomHandling = __webpack_require__(145),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(146); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(65).concat(__webpack_require__(92)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(93).concat(__webpack_require__(159)) },
...
var _nodeFetch = __webpack_require__(142);
...
var convert = __webpack_require__(143).convert;
var bodyStream = __webpack_require__(164);
